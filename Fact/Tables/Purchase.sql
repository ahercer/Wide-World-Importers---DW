...
EXECUTE sp_addextendedproperty @name = N'Description', @value = 'Auto-created to support a foreign key', @level0type = N'SCHEMA', @level0name = N'Fact', @level1type = N'TABLE', @level1name = N'Purchase', @level2type = N'INDEX', @level2name = N'FK_Fact_Purchase_Date_Key';
GO
...
EXECUTE sp_addextendedproperty @name = N'Description', @value = 'Auto-created to support a foreign key', @level0type = N'SCHEMA', @level0name = N'Fact', @level1type = N'TABLE', @level1name = N'Purchase', @level2type = N'INDEX', @level2name = N'FK_Fact_Purchase_Stock_Item_Key';
GO
...
EXECUTE sp_addextendedproperty @name = N'Description', @value = 'Auto-created to support a foreign key', @level0type = N'SCHEMA', @level0name = N'Fact', @level1type = N'TABLE', @level1name = N'Purchase', @level2type = N'INDEX', @level2name = N'FK_Fact_Purchase_Supplier_Key';
GO
...
ALTER TABLE [Fact].[Purchase]
    ADD CONSTRAINT [PK_Fact_Purchase] PRIMARY KEY CLUSTERED ([Purchase Key] ASC);
GO
