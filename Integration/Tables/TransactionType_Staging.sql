...
ALTER TABLE [Integration].[TransactionType_Staging]
    ADD CONSTRAINT [PK_Integration_TransactionType_Staging] PRIMARY KEY CLUSTERED ([Transaction Type Staging Key] ASC);
GO
